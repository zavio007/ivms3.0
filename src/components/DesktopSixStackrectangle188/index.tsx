...
type DesktopSixStackrectangle188Props = Omit<
  React.DetailedHTMLProps<React.HTMLAttributes<HTMLDivElement>, HTMLDivElement>,
  "username" | "featuresselected" | "recontext"
> &
  Partial<{ username: string; featuresselected: string; recontext: string }>;

const DesktopSixStackrectangle188: React.FC<
  DesktopSixStackrectangle188Props
> = (props) => {
  return (
    <>
      <div className={props.className}>
        ...
        <div className="absolute bg-gradient2  bottom-[0] flex flex-col inset-x-[0] items-center justify-end mx-auto p-[13px] rounded-[20px] shadow-bs w-full">
          <div className="flex flex-col gap-[5px] items-start justify-start mt-[212px] w-[99%] md:w-full">
            <Text
              className="text-lg text-white-A700"
              size="txtMontserratMedium18WhiteA700"
            >
              {props?.username}
            </Text>
            <div className="flex flex-row items-start justify-start w-full">
              ...
              <div className="bg-green-A700 h-[9px] ml-[154px] my-1 rounded w-[9px]"></div>
              <Text
...
DesktopSixStackrectangle188.defaultProps = {
  username: "Cameraname lorem",
  featuresselected: "3 Features Selected",
  recontext: "REC ON",
};

export default DesktopSixStackrectangle188;
